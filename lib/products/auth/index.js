...
import { IS_RAW_OBJECT, deserializeE2E, serializeE2E, simplifyCaughtError, simplifyError } from "../../helpers/utils.js";
...
export const authRoutes = ({
    ...
    ...authRoute.map(v => ({ mroute: btoa(v), route: v, ugly: true }))
...
export const authLiveRoutes = ({ projectName, logger, enforceETE_Encryption }) => [
    ...
    ...authLivePath.map(v => ({ mroute: btoa(v), route: v, ugly: true }))
].map(({ route, mroute, ugly }) =>
