...
import { ADMIN_DB_NAME, ADMIN_DB_URL, AUTH_PROVIDER_ID, EnginePath, EngineRoutes } from "../../helpers/values.js";
            ...
            switch (route) {
                case _customSignup:
                    const [emailx, passwordx, namex = ''] = _.split('.').map(v => decodeBinary(v)),
                        ...
                        { metadata = metax || {}, profile, uid: d_uid } = (await sneakSignupAuth?.(aBuild)) || {},
