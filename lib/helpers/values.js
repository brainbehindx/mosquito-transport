...
export const ERRORS = {
    ...
    ACCOUNT_ALREADY_EXIST: simplifyError('account_already_exist', 'This account already on the system'),
    ...
    UNEXPECTED_TOKEN_ISSUER: simplifyError('unexpected_token_issuer', 'The provided token has an unexpected issuer'),
    UNEXPECTED_TOKEN_AUDIENCE: simplifyError('unexpected_token_audience', 'The provided token has an unexpected audience'),
    AUTH_INVALID_TOKEN: simplifyError('auth_invalid_token', 'The provided token is invalid'),
    AUTH_TOKEN_EXPIRED: simplifyError('auth_token_expired', 'The token provided has already expired'),
    // google auth
    GOOGLE_AUTH_DISABLED: simplifyError(
        'google_auth_disabled',
        'You have not enable google auth yet, provide the "googleAuthConfig" in MosquitoTransportServer() constructor to enable this feature'
    ),
    ...
    // apple auth
    APPLE_AUTH_DISABLED: simplifyError(
        'apple_auth_disabled',
        'You have not enable apple auth yet, provide the "appleAuthConfig" in MosquitoTransportServer() constructor to enable this feature'
    ),
    APPLE_AUTH_FAILED: simplifyError('apple_auth_failed', 'This user could not be authenticated'),
    // STORAGE
